...
module App.Api.AssessmentTaking {

    export interface IAssessmentTakingApi {
    ...
    class AssessmentTakingApi extends ApiBase implements IAssessmentTakingApi {
        resourceUrl = 'assessment-taking';
    ...
    angular
        .module("app.api.assessment-taking", [])
        .service("api.assessment-taking", AssessmentTakingApi);
} 
