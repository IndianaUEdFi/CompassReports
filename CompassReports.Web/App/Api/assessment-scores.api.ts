...
module App.Api.AssessmentScores {

    export interface IAssessmentScoresApi {
    ...
    class AssessmentScoresApi extends ApiBase implements IAssessmentScoresApi {
        resourceUrl = 'assessment-scores';
    ...
    angular
        .module("app.api.assessment-scores", [])
        .service("api.assessment-scores", AssessmentScoresApi);
} 
