...
module App.Api.AssessmentPerformanceTrend {

    export interface IAssessmentPerformanceTrendApi {
    ...
    class AssessmentPerformanceTrendApi extends ApiBase implements IAssessmentPerformanceTrendApi {
        resourceUrl = 'assessment-performance-trend';
    ...
    angular
        .module("app.api.assessment-performance-trend", [])
        .service("api.assessment-performance-trend", AssessmentPerformanceTrendApi);
} 
